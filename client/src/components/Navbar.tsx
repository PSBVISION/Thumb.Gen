    ...
    <>
      ...
      >
        <Link to="/" className="flex items-center">
          ...
          <p className="px-2 text-2xl font-bold pt-0.5">
            Thumb
            <span className="text-pink-500 font-extrabold text-3xl">.</span>Gen
          </p>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
          ...
          {isLoggedIn ? (
            ...
            <Link to="#features" className="hover:text-pink-500 transition">
              Features
            </Link>
          )}
        ...
        <div className="flex items-center gap-2">
          {isLoggedIn ? (
            <div className="relative group pl-0 md:pl-25">
              <button className="rounded-full size-8 text-xl bg-white/20 border-2 border-white/10">
      ...
      <div
        className={`fixed inset-0 z-100 bg-zinc-800/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${
