        ...
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img className="h-full w-auto object-cover object-left border-[1.5px] border-pink-600 rounded-3xl" src="/assets/features-showcase-1.png" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop guessing and start creating. Our AI generate designs proven to capture attention.</p>
